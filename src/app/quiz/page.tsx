              ...
              <div key={i} className={`border-4 border-black p-4 shadow-[3px_3px_0px_black] ${a.isCorrect ? 'bg-green-50' : 'bg-red-50'}`}>
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <div className="font-black text-sm mb-2">Q{i + 1}: {a.question}</div>
                    <div className="space-y-1 text-sm">
                      {a.options.map((opt) => {
                        ...
                        return (
                          ...
                          >
                            {isSelected && !isCorrectOpt ? '✗ ' : isCorrectOpt ? '✓ ' : '  '}{opt}
                          </div>
                        );
                      })}
                    </div>
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className="border-4 border-black bg-white shadow-[6px_6px_0px_black] p-6">
        ...
        <div className="text-xl font-black">{q.card.front}</div>
      </div>
      ...
      <div className="space-y-3">
        {q.options.map((option, i) => {
          ...
          return (
            ...
            >
              <span className="font-black mr-3">{String.fromCharCode(65 + i)}.</span>{option}
            </button>
          );
        })}
      </div>
